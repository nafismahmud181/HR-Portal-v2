        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="rounded-lg border border-[#e5e7eb] bg-white p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex gap-3">
              <a href="/register" className="inline-flex items-center justify-center rounded-md bg-[#1f2937] text-white px-6 py-3 text-[16px] font-medium hover:bg-[#111827] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#f97316]">
                Signup
              </a>
